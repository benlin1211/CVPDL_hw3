...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    if pt:
        ...
        model.model[layer_selected].register_forward_hook(get_features('desired_feature_layer'))
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        if pt:
            ...
            print("hi all_",features['desired_feature_layer'].shape)
...
def parse_opt():
    ...
    parser.add_argument('--file_name',default='./all_feature.npy')
    ...
    parser.add_argument('--conf-thres', type=float, default=0.01, help='confidence threshold') # 0.5 0.25 0.1, 0.0
