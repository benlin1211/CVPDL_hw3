...
if __name__ == '__main__':
    ...
    if args.mode == "normal_to_adverse":
        ...
        args.output_dir ='./dataset/Normal_to_Foggy/images/Normal_fake/'
        args.name_list = './Normal_fake.txt'
    elif  args.mode == "adverse_to_normal":
        # args.input_dir = './dataset/Normal_to_Foggy/images/Foggy_train/'  # 
        args.output_dir ='./dataset/Normal_to_Foggy/images/Foggy_fake/'
        args.name_list = './Foggy_fake.txt'
