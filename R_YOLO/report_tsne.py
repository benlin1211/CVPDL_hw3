...
features_A = np.load("all_feature_3.npy")
labels_A = np.zeros(features_A.shape[0])

features_B = np.load("all_feature_4.npy")
...
plt.title('t-SNE: Adapted model inference', fontsize=12)
plt.legend(handles=scatter.legend_elements()[0], labels=classes)
save_img_as = "./report_bonus34.png" # = os.path.join(output_dir, f"Report 2-3 usps tsne by class.png")
